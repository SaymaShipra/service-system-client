...
//     newService.categories = categories;
...
//         className="mt-10 w-10/12 mx-auto bg-base-100 p-10"
//       >
//         <div>
...
const AddService = () => {
  ...
  // Format current date as "DD MMM YYYY" (e.g. "15 Jun 2025")
  const currentDate = new Date().toLocaleDateString("en-GB", {
    day: "2-digit",
    month: "short",
    year: "numeric",
  ...
  const handleAddService = (e) => {
    ...
    // Convert form entries to an object
    const newService = Object.fromEntries(formData.entries());
